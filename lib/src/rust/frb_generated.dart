...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiLibsqlConnectConstMeta =>
  ...
  TaskConstMeta get kCrateApiLibsqlInitAppConstMeta =>
  ...
  Map<String, LibsqlReturnValue> dco_decode_Map_String_libsql_return_value_None(
    ...
    return Map.fromEntries(
      dco_decode_list_record_string_libsql_return_value(
        raw,
  ...
  Map<String, LibsqlValue> dco_decode_Map_String_libsql_value_None(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return Map.fromEntries(
      dco_decode_list_record_string_libsql_value(
        raw,
      ).map((e) => MapEntry(e.$1, e.$2)),
    );
  }
  ...
  LibsqlReturnValue dco_decode_libsql_return_value(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return LibsqlReturnValue_Integer(dco_decode_i_64(raw[1]));
      case 1:
        return LibsqlReturnValue_Real(dco_decode_f_64(raw[1]));
      case 2:
        return LibsqlReturnValue_Text(dco_decode_String(raw[1]));
      case 3:
        return LibsqlReturnValue_Blob(dco_decode_list_prim_u_8_strict(raw[1]));
      case 4:
  ...
  LibsqlValue dco_decode_libsql_value(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return LibsqlValue_Integer(dco_decode_i_64(raw[1]));
      case 1:
        return LibsqlValue_Real(dco_decode_f_64(raw[1]));
      case 2:
        return LibsqlValue_Text(dco_decode_String(raw[1]));
      case 3:
        return LibsqlValue_Blob(dco_decode_list_prim_u_8_strict(raw[1]));
      case 4:
  ...
  (String, LibsqlReturnValue) dco_decode_record_string_libsql_return_value(
    ...
    return (dco_decode_String(arr[0]), dco_decode_libsql_return_value(arr[1]));
  }
  ...
  (String, LibsqlValue) dco_decode_record_string_libsql_value(dynamic raw) {
    ...
    return (dco_decode_String(arr[0]), dco_decode_libsql_value(arr[1]));
  }
  ...
  QueryResult sse_decode_query_result(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_rows = sse_decode_list_Map_String_libsql_return_value_None(
      deserializer,
    );
  ...
  void sse_encode_Map_String_libsql_return_value_None(
    Map<String, LibsqlReturnValue> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_box_autoadd_libsql_transaction_behavior(
    LibsqlTransactionBehavior self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_list_Map_String_libsql_return_value_None(
    List<Map<String, LibsqlReturnValue>> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_list_record_string_libsql_return_value(
    List<(String, LibsqlReturnValue)> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
...
class InnerTransactionImpl extends RustOpaque implements InnerTransaction {
  ...
  static final _kStaticData = RustArcStaticData(
    ...
    rustArcDecrementStrongCountPtr: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_InnerTransactionPtr,
  );
}
...
class LibsqlConnectionImpl extends RustOpaque implements LibsqlConnection {
  ...
  Future<void> disableExtension() => RustLib.instance.api
      .crateApiConnectionLibsqlConnectionDisableExtension(that: this);

  Future<void> enableExtension() => RustLib.instance.api
      .crateApiConnectionLibsqlConnectionEnableExtension(that: this);
  ...
  Future<void> sync_() =>
      RustLib.instance.api.crateApiConnectionLibsqlConnectionSync(that: this);
...
class LibsqlStatementImpl extends RustOpaque implements LibsqlStatement {
  ...
  Future<void> finalize() =>
      RustLib.instance.api.crateApiStatementLibsqlStatementFinalize(that: this);
...
class LibsqlTransactionImpl extends RustOpaque implements LibsqlTransaction {
  ...
  static final _kStaticData = RustArcStaticData(
    ...
    rustArcDecrementStrongCountPtr: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_LibsqlTransactionPtr,
  );

  Future<void> commit() => RustLib.instance.api
      .crateApiTransactionLibsqlTransactionCommit(that: this);
  ...
  Future<void> rollback() => RustLib.instance.api
      .crateApiTransactionLibsqlTransactionRollback(that: this);
}
